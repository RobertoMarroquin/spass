...
class IndicadorRelacionadosList(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = Indicador.objects.filter(Q(id=indicador_id)|Q(indicador_general=indicador_id)|Q(indicador_general=indicador.indicador_general)|Q(id=indicador.indicador_general))
        return queryset
